...
function Dashboard({user,onLogout}){
  ...
  const features=[
    ...
    {icon:"📋",label:isTe?"పత్రాల చెక్‌లిస్ట్":"Document Checklist",sub:isTe?"8 పత్రాలు తనిఖీ":"Check 8 documents",action:()=>setShowChecklist(true),highlight:true},
    ...
    {icon:"🛰️",label:isTe?"శాటిలైట్ వ్యూ":"Satellite View",sub:isTe?"Google Maps":"Google Maps",action:()=>window.open("https://maps.google.com","_blank")},
    {icon:"📊",label:isTe?"నా రికార్డులు":"My Records",sub:isTe?"భూమి రికార్డులు":"Land Records",action:()=>{}},
  ];
